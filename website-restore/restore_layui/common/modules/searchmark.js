layui.define(function(exports){
	var element = layui.element,
		...
		//表头工具栏触发事件
		table.on('toolbar(markT)', function(obj){
		...
		//行工具条事件
		table.on('tool(markT)', function(obj){
	...
	exports('searchmark', {msg:'This is page seachmark.html`s modules'}); //注意，这里是模块输出的核心，模块名必须和 use 时的模块名一致
}); 